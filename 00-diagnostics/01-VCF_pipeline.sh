...
# echo "/data/programs/scripts/hoppmann/00-diagnostics/pipeline/02-load-in-gemini.sh $annotateDir $databaseDir"
...
# echo "/data/programs/scripts/hoppmann/00-diagnostics/pipeline/03-annotate_alamut.sh $mergedOut $databaseDir/merged.db $runAlamut"
